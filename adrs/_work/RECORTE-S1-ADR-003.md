...
| **S1c2** | resto de 2 | 1.258 | S1c1 (`page_revisions`, `revision_status_events`) | `revision_current_status` (projeção, também com `workspace_id`) e o trigger `revision_status_events_apply`. Só otimiza leitura e automatiza o efeito de publicar, nada que S1c1 deixasse quebrado |
