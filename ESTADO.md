...
| 4 | ADR 002 F3: URIs e referências | Ordem escrita em 9.318 caracteres contra os 31.449 da F1, com a tabela de restrições funcionando de primeira. Uma correção de mecanismo em curso (`DDP-79`), depois revisão da sessão C |
