...
**A primeira migração do projeto está sendo aplicada** (`DDP-98`), aprovada pela sessão C em duas passadas e pelo dono do produto em `DDP-99`, nas duas categorias.
