...
- **A sessão A nunca põe uma issue num status que a própria JQL dela vigia.** A escuta usa status como sinal de que outra sessão ou o humano agiu. Status posto pela sessão A é sinal falso, e o custo é um ciclo inteiro de escuta gasto com trabalho que ela mesma acabou de fazer. Aconteceu duas vezes em 2026-09-20, com a ordem da fatia F1 deixada em `EM REVISÃO` e com a issue de revisão do dono do produto criada em `EM ANDAMENTO`.
