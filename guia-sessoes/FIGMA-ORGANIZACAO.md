...
- Fonte da legenda, fixada pela sessão A em 2026-09-22 na `DDP-452`: Inter Regular 11, cor `muted-foreground` por variável, centralizada sob o nó, com a mesma largura do nó e 8px abaixo dele. Vale dentro e fora de Section, no Design System e em toda prancha. Um só tamanho por arquivo.
